...
//
//                    JSONObject weatherArray = content.getJSONArray("meanings");
                    JSONObject mainObj = content.getJSONObject(0);
                    JSONArray meanings = mainObj.getJSONArray("meanings");
                    JSONObject meaningsObj = meanings.getJSONObject(0);
                    JSONArray definitions = meaningsObj.getJSONArray("definitions");
                    JSONObject definitionsObj = definitions.getJSONObject(0);
//                    Log.i(Constants.TAG, meanings.toString() );


//                    JSONObject definitions = weather.getJSONObject("definitions");
//
//                    result = definitions.toString();

//                    Log.i(Constants.TAG, weather.toString() );
                    result = "please work";
                    result = pageSourceCode;
                    result = definitionsObj.getString("definition");
